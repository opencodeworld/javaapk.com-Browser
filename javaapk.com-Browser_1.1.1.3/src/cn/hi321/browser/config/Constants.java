package cn.hi321.browser.config;
...
public class Constants {
	...
	public static final String URL_ABOUT_URL = "file:///android_asset/index/index.html";
	public static final String URL_ABOUT_HOME = "file:///android_asset/startpage/";
	public static final String URL_ABOUT_VIDEO = "file:///android_asset/startpage/start.html";
	public static final String URL_ERROR = "file:///android_asset/errorpage/loaderror.html";
	public static final String URL_ACTION_SEARCH = "action:search?q=";
	public static final String URL_ACTION_CALL = "wtai://wp/mc;";
	public static final String URL_ACTION_TEL = "tel";
	 ...
	 * Preferences.
	 */
	public static final String PREFERENCES_GENERAL_HOME_PAGE = "GeneralHomePage";//主页设置
	...
	public static final String PREFERENCES_SHOW_FULL_SCREEN = "GeneralFullScreen";//全屏设置
	...
	public static final String PREFERENCES_SEARCH_TABID_POP = "PREFERENCES_SEARCH_POP_POP";
